        ...
        <div className="card-header py-3">
                ...
                <div className="panel panel-primary">
                    ...
                    <tbody><tr>
                        ...
                        <td></td>
                        <td></td>
                        <td>Chưa thanh toán,<br></br> Đã thanh toán</td>
                        <td>Chưa duyệt</td>
                        <td>
                            <a href=""><button className="btn btn-primary">Duyệt</button></a> <br /><br />
                            <a href=""><button className="btn" style={{backgroundColor: 'red', color: 'white', padding: '6px 18px', marginTop: 5}}>Hủy</button></a>
                        </td>
                        <td><a href=""><button className="btn btn-warning">Xem</button></a></td>
